...
import net.sharplab.translator.generated.model.Language
...
class LanguagesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    * @param code Language code as used by a CAT tool. Must be used together with &#x60;tool&#x60;.  (optional)
    * @param tool CAT tool for looking up a language code in Globalese. Must be used together with &#x60;code&#x60;.  (optional)
    * @param usage Filter for languages used in corpora, engines or projects.  Optionally, the &#x60;:source&#x60; or &#x60;:target&#x60; modifier may be appended to the parameter value to filter for languages used on the source or target language side only.  &#x60;usage&#x3D;corpora:source&#x60; will return a list of languages used as corpus source languages.  &#x60;usage&#x3D;engines&#x60; will return a list of languages used as engine languages, either source or target.  (optional)
    ...
    */
    ...
    fun languagesGet(limit: kotlin.Int?, offset: kotlin.Int?, code: kotlin.String?, tool: kotlin.String?, usage: kotlin.String?) : kotlin.collections.List<Language> {
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                ...
                if (usage != null) {
                    put("usage", listOf(usage.toString()))
                }
            }
        ...
        val localVarResponse = request<kotlin.collections.List<Language>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<Language>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun languagesIdGet(id: kotlin.String) : Language {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/languages/{id}".replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Language>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as Language
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
