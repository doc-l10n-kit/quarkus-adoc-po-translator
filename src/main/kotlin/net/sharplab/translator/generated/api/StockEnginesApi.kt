...
import net.sharplab.translator.generated.model.StockEngine
...
class StockEnginesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    /**
    * List stock engines
    * Returns a list of available stock engines, optionally filtered.  Required permission: &#x60;MANAGE_ENGINES|MANAGE_PROJECTS|SYSTEM_ADMINISTRATOR&#x60; 
    * @param source Source language. Examples: &#x60;en&#x60;, &#x60;fr&#x60;  (optional)
    * @param target Target language. Examples: &#x60;en&#x60;, &#x60;fr&#x60;  (optional)
    * @return kotlin.collections.List<StockEngine>
    ...
    */
    ...
    fun stockEnginesGet(source: kotlin.String?, target: kotlin.String?) : kotlin.collections.List<StockEngine> {
        ...
        val localVarResponse = request<kotlin.collections.List<StockEngine>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<StockEngine>
