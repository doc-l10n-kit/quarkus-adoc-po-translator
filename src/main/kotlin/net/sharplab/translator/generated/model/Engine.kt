...
import net.sharplab.translator.generated.model.EngineCorpora
 ...
 * @param ready 
 * @param version 
 * @param stockEngine Whether or not the engine is based on a stock engine
 * @param corpora 
 */
...
data class Engine (
    ...
    /* Whether or not the engine is based on a stock engine */
    @Json(name = "stock_engine")
    val stockEngine: kotlin.Boolean,
    @Json(name = "corpora")
    val corpora: EngineCorpora
) {

    /**
    * Training status
    * Values: changed,empty,error,queued,trained,training
    */
    ...
    enum class Status(val value: kotlin.String){
        ...
        @Json(name = "trained") trained("trained"),
