...
import net.sharplab.translator.generated.model.CorpusMetadata
 ...
 * @param segmentCount 
 * @param sourceWordcount 
 * @param targetWordcount 
 * @param sourceCharacterCount 
 * @param targetCharacterCount 
 * @param groups 
 * @param engines 
 * @param metadata 
 */
...
data class Corpus (
    ...
    val segmentCount: kotlin.Int,
    @Json(name = "source_wordcount")
    val sourceWordcount: kotlin.Int,
    @Json(name = "target_wordcount")
    val targetWordcount: kotlin.Int,
    @Json(name = "source_character_count")
    val sourceCharacterCount: kotlin.Int,
    @Json(name = "target_character_count")
    val targetCharacterCount: kotlin.Int,
    @Json(name = "groups")
    val groups: kotlin.collections.List<kotlin.Int>,
    @Json(name = "engines")
    val engines: kotlin.collections.List<kotlin.Int>? = null,
    @Json(name = "metadata")
    val metadata: CorpusMetadata? = null
)
