...
/**
 * An engine cannot contain more than 500 corpora in total.
 * @param auxiliary 
 * @param core 
 * @param stock 
 */

data class EngineCorpora (
    @Json(name = "auxiliary")
    val auxiliary: kotlin.collections.List<kotlin.String>,
    @Json(name = "core")
    val core: kotlin.collections.List<kotlin.String>,
    @Json(name = "stock")
    val stock: kotlin.Boolean
)
