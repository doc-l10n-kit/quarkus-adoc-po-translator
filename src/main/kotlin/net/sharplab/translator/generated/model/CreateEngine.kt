 ...
 * @param group 
 * @param corpora 
 * @param stockEngine Create a new customised engine based on a stock engine.
 */

data class CreateEngine (
    @Json(name = "name")
    ...
    /* Create a new customised engine based on a stock engine. */
    @Json(name = "stock-engine")
    val stockEngine: kotlin.Boolean? = null
)
